...
class ProcessingReport:
    ...
    def quality_tier(self) -> QualityTier:
        ...
        if (
            self.avg_confidence >= studio_confidence_threshold
            and self.si_sdr >= min_si_sdr
        ):
    ...
    if report.quality_tier == QualityTier.STUDIO:
        ...
        return {
            ...
            "options": [
                {
                    "id": "raw",
                    "label": "Download raw output (free)",
                    "confidence_overlay": True,
                },
                {
                    "id": "human",
                    "label": "Human-reviewed refinement (+$4.99, 24h)",
                    "upsell": True,
                },
                {
                    "id": "cancel",
                    "label": "Cancel with full credit refund",
                    "refund": True,
                },
            ],
        }
