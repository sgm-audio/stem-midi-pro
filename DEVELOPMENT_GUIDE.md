...
- Use the synthetic data generators in `data/datasets.py` for initial development
...
python -c "from data.datasets import AudioDataset; d = AudioDataset('./data/synthetic'); print(len(d))"
