...
from mamba_ssm import Mamba, selective_scan_fn
...
class MambaSeparator(Module):
    ...
    def input_types(self):
        return {
            ...
            "state_cache": typecheck.Optional(NeuralType(('B', 'L', 'D'), ChannelType()))
        }
    ...
    def output_types(self):
        return {
            ...
            "metrics": NeuralType(('B'), ChannelType())  # SI-SDR estimate, phase coherence
        }
    ...
    def _estimate_si_sdr(self, guitar: torch.Tensor, bass: torch.Tensor) -> torch.Tensor:
